...
<head id="Head1" runat="server">
    <title>DevOps testing site</title>
    <style type="text/css">
    .cal
    {
        position:absolute;        
...
<body style="background-color:pink;">
    ...
    <div class="cal">
      <div style="margin-left:10%;margin-top:5%;"> <asp:Label ID="l" Text=" Demo CALCULATOR" runat="server" 
            Font-Bold="False" Font-Italic="False"></asp:Label>&nbsp;for build success </div>
      ...
      <div style="margin-left:5%;">
       ...
       <div style="margin-left:5%;">
        ...
        <asp:Button ID="div" Text="/" runat="server" Height="37px" Style="margin-left: 0px"
           ...
           <br />
           <br />
           <asp:Button ID="Button1" runat="server" OnClick="Button1_Click1" Text="Click on me!!!!" />
            </div>
    </div>
    </form>
</body>
